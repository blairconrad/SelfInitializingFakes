namespace SelfInitializingFakes
{
    ...
    /// <summary>
    /// Creates self-initializing fakes. That is, fakes that will delegate to an actual service when first
    /// used, creating a script that will be followed on subsequent uses.
    /// </summary>
    public static class SelfInitializingFake
    {
        ...
        public static SelfInitializingFake<TService> For<TService>(
